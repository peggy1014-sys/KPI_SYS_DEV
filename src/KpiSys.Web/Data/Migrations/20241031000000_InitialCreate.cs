        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    parentOrgId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    portfolioCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    orgLevel = table.Column<int>(type: "int", nullable: true),
